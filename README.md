# DIO---Educa-o-Financeira
Esse repositório refere-se a um caderno temático criado através da ferramenta NotebookLM, com a introdução sobre  educação financeira e planejamento financeiro pessoal.        

## Fontes utilizadas:
+ Secretaria da Educação do Estado de São Paulo**: Trata-se de um texto intitulado "Educação Financeira passa a ser disciplina nas escolas: 1 milhão de alunos aprendem a cuidar do dinheiro", que aborda a inclusão da disciplina na matriz curricular da rede estadual.
+ Blog Financia Tudo**: Corresponde ao texto "Educação financeira – Guia completo", que reúne conceitos, dicas práticas e orientações estratégicas para o controle das finanças pessoais.
+ SPC Brasil**: Refere-se ao artigo "Educação financeira: tudo o que você precisa saber para dar o primeiro passo", que detalha a importância do tema e oferece dicas para uma vida financeira saudável.
...
+ Necessidade vs. Desejo: Necessidades são itens indispensáveis para a vida (ex: alimentação básica); desejos são as formas como escolhemos satisfazê-las ou itens não essenciais que trazem prazer.
+ Orçamento: Ferramenta de planejamento para anotar e equilibrar receitas (entradas) e despesas (saídas).
...
"Prompts Reutilizáveis" (Roteiros e Orientações Práticas)
...
2. Guia de Gestão Pessoal (Financia Tudo)
Funciona como um manual prático para o cotidiano, focando na mudança da relação emocional com o dinheiro.
+ Destaque: Estabelece os pilares do controle financeiro: registro de receitas/despesas, diferenciação entre desejos e necessidades, criação de reserva de emergência e planejamento de longo prazo.
3. Primeiros Passos e Segmentação (SPC Brasil)
Explora os desafios e categorias da educação financeira, dividindo-a em Pessoal, Familiar e Empresarial.
+ Destaque: Oferece um roteiro de 5 passos para a saúde financeira: diagnóstico da situação atual, controle de gastos, definição de metas, pesquisa constante e criação do hábito de poupar.
